...
class BatteryMaximumCapacityPreferenceController(
    ...
    override fun getSummary(): CharSequence {
        ...
        val maxCapacityUah: Int = batteryIntent.getIntExtra(BatteryManager.EXTRA_MAXIMUM_CAPACITY, -1)
        val designCapacityUah: Int = batteryIntent.getIntExtra(BatteryManager.EXTRA_DESIGN_CAPACITY, -1)
